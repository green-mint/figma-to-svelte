<script>
	...
	import ScrollImageSync from '../components/ScrollImageSync.svelte';
...
<div class="px-4">
	...
	<div class="flex">
		<div class="w-[55%] py-44 px-3 space-y-20">
			<p class="text-3xl">
				Des solutions de chauffe <Bold>clé en main</Bold>, qui font promesse d’un confort absolu
				pour accueillir, au coin du feu, tous vos moments de vie.
			</p>
	...
	<div class="flex space-x-4">
		<div class="w-1/2 text-white bg-[#A0664F] py-20 rounded-xl px-14">
			...
			<div class="mt-48 w-5/6">
				<p>
					Ma Cheminée est une <strong>entreprise familiale</strong>, à taille humaine, portée par
					une volonté forte : trouver un appareil de chauffe adapté à vos envies, qui s’intègre
		...
		<div class="bg-[#415A48] w-1/2 pt-20 pb-12 rounded-xl px-14 text-white">
			...
			<div class="mt-24 w-10/12">
				...
				<p class="mt-6">
					...
					avisé, pour choisir un appareil de chauffe adapté à vos besoins, à votre habitat et à
					votre budget.
				</p>
			</div>
	...
	<div class="flex my-52">
		...
		<div class="w-[60%] flex overflow-clip">
			...
			<img
				class="h-fit z-30 relative top-44 right-60"
				src="/images/content/fireplace3.png"
				alt=""
			/>
		</div>
	</div>
	...
	<div class=" my-32">
		<div class="flex text-3xl pb-4 justify-between px-4">
			<div class="text-3xl">AVANT</div>
			<div class="text-3xl">APRÈS</div>
		</div>
		<div class="w-[1338px] h-[716px]">
			<CompareBeforeAfter  />
		</div>
	</div>
			...
			<div class="flex items-center space-x-8 my-10 mb-14">
				...
				<div>
					<p class="text-[0.9rem]">
						...
						cheminée. Chaque email comporte un lien pour gérer / supprimer mes données et
						préférences email. En savoir plus sur nos politiques de confidentialité.
					</p>
				</div>
			</div>
